...
from dataset_agent.agents.crawl_agent import build_agent
from dataset_agent.agents.prompts import CRAWL_EXTRACT_SYSTEM, RESCRAPE_SYSTEM, RESCRAPE_HUMAN
from dataset_agent.agents.state import DatasetState



from dataset_agent.utils.logging import log_section, get_logger
...
from dataset_agent.db.db import get_sources, insert_observation, get_datasets, update_source_status, get_observations  # <-- add this
...
"""
        ...
        try:
            ...
            if is_duplicate_observation(
                ...
                logger.info("Skipping duplicate observation")
                processed.append(source_id)
                update_source_status(db, source_id, processed=1, crawl_status="rescraped" if is_rescrape else "scraped")
                continue
